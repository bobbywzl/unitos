...
**Intent:** Notes auto-save that survives a closed tab, a page change, or a lost machine, with a save state on every note being edited; every current account Unitos Ultra; the tier chip out of the reader; the AI toolbar on the article card of a video or audio document.
...
- `SPEC.md`, `TIERS.md` — §6 auto-save and save state; §11 the article card; tier decisions.
