...
try{var tray=sessionStorage.getItem(${JSON.stringify(trayStateKey(notebookId))});
if(tray&&JSON.parse(tray).collapsed===true)css+=".tray-column{width:0!important;transition:none!important}";}catch(e){}
