...
const zh: Record<keyof typeof en, string> = {
  ...
  downloadDocx: "下载：Microsoft Word (.docx)",
  downloadPdf: "下载：PDF 文档 (.pdf)",
  downloadTxt: "下载：纯文本 (.txt)",
  downloadHtml: "下载：网页 (.html)",
  downloadMarkdown: "下载：Markdown (.md)",
  choosePdf: "请选择“另存为 PDF”",
  makeCopy: "创建副本",
  copyDocument: "复制文档",
  copyName: "名称",
  copyOf: "{title} 的副本",
