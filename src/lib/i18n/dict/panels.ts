...
const en = {
  ...
  contextDesc: "Injected into every AI prompt: notes, distillation, analysis. Every field is optional.",
  fieldBackground: "Background",
  fieldBackgroundPh: "e.g. Stanford student, stochastic calc + stats + quantum",
  fieldPurpose: "Purpose",
  fieldPurposePh: "e.g. due diligence, exam prep, replicate results",
  fieldApplication: "Application",
  fieldApplicationPh: "e.g. investment decision for Bough Capital",
...
const zh: Record<keyof typeof en, string> = {
  ...
  contextDesc: "注入每一个 AI 提示词：笔记、提炼、分析。每个字段都可不填。",
  fieldBackground: "背景",
  fieldBackgroundPh: "如：斯坦福学生，修过随机微积分、统计和量子力学",
  fieldPurpose: "目的",
  fieldPurposePh: "如：尽职调查、备考、复现结果",
  fieldApplication: "用途",
  fieldApplicationPh: "如：Bough Capital 的投资决策",
  scopeEverywhere: "全局",
