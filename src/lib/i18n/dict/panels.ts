...
const en = {
  ...
  keypointsButtonTitle: "The AI reads the whole article and writes its most important points as bullets",
  keypointsEmpty: "No distillation yet. Distill the article; its most important points list here.",
  openKeypoints: "Open the distillation",
  pointCountOne: "{n} point",
  pointCountMany: "{n} points",
  ...
  distillEmpty:
    "No extractions yet. Ask the article one question; the quotes that answer it list here.",
  ...
  describeLink: "Describe",
  describeLinkTitle: "Say what this link is about",
  editLinkAboutTitle: "Change what this link is about",
...
const zh: Record<keyof typeof en, string> = {
  ...
  keypointsButtonTitle: "AI 通读全文，把最重要的要点写成分条",
  keypointsEmpty: "还没有提炼。提炼文章，最重要的要点会列在这里。",
  openKeypoints: "打开提炼",
  pointCountOne: "{n} 条要点",
  pointCountMany: "{n} 条要点",
  distillNoDoc: "打开一篇文本文档即可提炼或提取。",
  distillArticle: "从文章提取",
  distillCorpusTitle: "一个问题；AI 扫描项目中的每个文档",
  distillButtonTitle: "向文章提一个问题，AI 会找出回答它的引文",
  distillEmpty: "还没有提取。向文章提一个问题，回答它的引文会列在这里。",
  ...
  describeLink: "添加说明",
  describeLinkTitle: "说明这个链接是关于什么的",
  editLinkAboutTitle: "修改链接说明",
