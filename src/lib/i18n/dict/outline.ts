...
const en = {
  ...
  reorderNote: "Drag to reorder this note; hold it over another until the ring closes to merge",
  gripTitle: "Drag up or down to reorder; hold this note over another until the ring closes to merge; drag sideways to float it over the article",
  ...
  // a card dropped on the floating note card. Merge with AI and Join text are
  // the ticker's bulk actions; a drag always merges with AI.
...
const zh: Record<keyof typeof en, string> = {
  ...
  saved: "已保存",
  saveFailed: "未保存",
  reorderNote: "拖动以调整此笔记的顺序；把它压在另一条上按住直到圆环合拢即可合并",
  gripTitle: "上下拖动调整顺序；把此笔记压在另一条上按住直到圆环合拢即可合并；横向拖动让它浮在文章上",
