...
const en = {
  ...
  more: "More",
  workspace: "Workspace",
  // Tooltips: one caption per control in the header and the rail
  allCorporaTitle: "Back to all projects",
  pendingCountTitle: "Notes waiting for your Accept or Reject",
  assistantTitle: "Ask the assistant about this project or all your projects",
  notesTitle: "Your notes by section, with the pending queue",
  distillTitle: "Ask the article or the project one question; the AI pulls the quotes that answer it",
  annotationsTitle: "Every highlight, comment, explanation, and link in this document",
  editHistoryTitle: "Every edit to this document, newest first; revert or restore",
  moreTitle: "Notes full page and Settings",
  ...
  readerViewTitle: "One document, or two side by side or top and bottom",
  secondPaneDocumentTitle: "Pick the document for the second pane",
  ...
  removeParagraphTitle: "Remove this paragraph; notes anchored to it show as unresolved",
  ...
  documentActionsTitle: "Re-parse, print, recommend links, or detach this document",
  documentList: "Documents in this project",
  documentListTitle: "The open document. Hover for every document in this project",
  ...
  addDocumentTitle: "Add a document: PDF, video, audio, URL, Google Drive, or the library",
...
const zh: Record<keyof typeof en, string> = {
  ...
  pendingCountTitle: "等待你接受或拒绝的笔记",
  assistantTitle: "就此项目或全部项目向助手提问",
  notesTitle: "按章节排列的笔记，以及待定队列",
  distillTitle: "向文章或项目提一个问题，AI 找出回答它的引文",
  annotationsTitle: "此文档的全部高亮、评论、解释和链接",
  editHistoryTitle: "此文档的每处编辑，最新在前；可还原或恢复",
  moreTitle: "整页笔记与设置",
  ...
  readerViewTitle: "单文档，或两篇左右分屏、上下分屏",
  secondPaneDocumentTitle: "选择第二窗格的文档",
  ...
  indentLine: "增加当前行缩进",
  removeParagraph: "移除 ¶",
  removeParagraphTitle: "移除此段落；锚定到它的笔记将显示为无法定位",
  ...
  documentActionsTitle: "重新解析、打印、扫描推荐链接，或移出此文档",
  documentList: "此项目的文档",
  documentListTitle: "当前打开的文档。悬停查看此项目的全部文档",
  ...
  addDocument: "添加文档",
  addDocumentTitle: "添加文档：PDF、视频、音频、URL、Google Drive 或文档库",
  uploadPdf: "上传 PDF",
  uploadVideo: "上传视频或音频",
