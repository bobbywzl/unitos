...
const en = {
  ...
  workspace: "Workspace",
  assistantTabTitle: "Assistant: ask about this page or the project; run checks",
  ...
  textColorWheel: "Color the text any color",
  highlightText: "Highlight the text",
  highlightColorWheel: "Pick the highlight color",
  ...
  dropPdfOrVideo: "Drop PDF, image, Markdown, slides (pptx), sheets (xlsx, csv), video, or audio files.",
  ...
  // Folders in the document list (document-folders.tsx; SPEC.md §6)
  newFolder: "New folder",
  newFolderTitle: "Make a folder to group documents",
  newFolderInside: "New folder inside",
  newFolderInsideTitle: "Make a folder inside this folder",
  folderNamePlaceholder: "Folder name",
  folderActions: "Folder actions",
  folderActionsFor: "Folder actions: {title}",
  renameFolder: "Rename folder",
  moveToFolder: "Move to folder",
  moveToFolderTitle: "Move this document to a folder",
  moveFolderTitle: "Move this folder into another folder",
  moveToFolderChoose: "Where to",
  ...
  reparseChoose: "Parse the PDF again as:",
  reparseAsHandwritten: "Handwritten pages",
  reparseAsHandwrittenTitle: "Keep the PDF as its pages, drawn as they are, and convert the handwriting again",
  ...
  blankDocumentTitle: "Start an empty document and write it here",
  ...
  queueHint: "Add more links or files, then press Continue. Each opens on its own page.",
  continue: "Continue",
  continueWithCount: "Continue with {n}",
  projectTitle: "Project title",
  projectTitleHint: "Name the project. You can rename it any time from the title at the top.",
  titleSaveFailed: "The title did not save",
  uploadQueuedBehind: "Queued: it starts when the running add is done.",
  ...
  uploadRangeDesc:
    "Move the handles to keep part of the recording. The transcription, the assistant, and every tool read that part alone; the file stays whole.",
  uploadRangeLoading: "Reading the recording…",
  uploadRangeStart: "Start",
  uploadRangeEnd: "End",
  uploadRangeWhole: "Import the whole recording",
  uploadRangePart: "Import {start}–{end}",
  ...
  selectDistillation: "Select this extraction",
  ...
  historySmallEdits: "{n} small edits",
  historyShowSmall: "Show",
  historyHideSmall: "Hide",
  ...
  graphPickHint: "Picking documents for Stitch: click a node to pick it or to drop it. Press Done in the Stitch box when the pick is complete.",
  ...
  acceptLink: "Accept",
  dismissLink: "Dismiss",
  linkExpand: "Show why this link was made, with the passage at each end",
  linkCollapse: "Fold this link",
  linkWhy: "Why this link",
  linkNoReason: "Linked by hand, with no reason written",
  linkOpenEnd: "Open in reader",
...
const zh: Record<keyof typeof en, string> = {
  ...
  workspace: "工作区",
  assistantTabTitle: "助手：就此页面或此项目提问；运行检查",
  ...
  textColorWheel: "把文字染成任意颜色",
  highlightText: "高亮文字",
  highlightColorWheel: "选择高亮颜色",
  outdentLine: "减少当前行缩进",
  indentLine: "增加当前行缩进",
  removeParagraph: "移除 ¶",
  ...
  ingestFailed: "导入失败",
  dropPdfOrVideo: "请拖放 PDF、图片、Markdown、幻灯片（pptx）、电子表格（xlsx、csv）、视频或音频文件。",
  ...
  newFolder: "新建文件夹",
  newFolderTitle: "新建文件夹来归类文档",
  newFolderInside: "在里面新建文件夹",
  newFolderInsideTitle: "在此文件夹里新建文件夹",
  folderNamePlaceholder: "文件夹名称",
  folderActions: "文件夹操作",
  folderActionsFor: "文件夹操作：{title}",
  renameFolder: "重命名文件夹",
  moveToFolder: "移到文件夹",
  moveToFolderTitle: "把此文档移到某个文件夹",
  moveFolderTitle: "把此文件夹移到另一个文件夹里",
  moveToFolderChoose: "移到哪里",
  folderRoot: "不放入文件夹",
  deleteFolder: "删除文件夹",
  deleteFolderTitle: "删除此文件夹；里面的内容上移一层",
  confirmDeleteFolder: "删除此文件夹？里面的文档和文件夹会上移一层。",
  folderEmpty: "此文件夹中没有文档",
  reparseStale: "旧版导入",
  ...
  reparseChoose: "以何种方式重新解析此 PDF：",
  reparseAsHandwritten: "手写页面",
  reparseAsHandwrittenTitle: "保留 PDF 的页面原样，并重新转换手写内容",
  ...
  library: "文档库",
  blankDocument: "空白文档",
  blankDocumentTitle: "新建一个空文档，在这里写",
  untitledDocument: "未命名文档",
  urlHint: "网页会成为可阅读的文档；YouTube 链接和视频/音频文件的直链会成为视频文档。",
  documentUrl: "文档 URL",
  queueLink: "加入列表",
  queuedCount: "已加入 {n} 项",
  queueHint: "继续添加链接或文件，然后按继续。每项在自己的页面打开。",
  continue: "继续",
  continueWithCount: "继续（{n} 项）",
  projectTitle: "项目标题",
  projectTitleHint: "给项目起个名字。之后随时可以在顶部的标题处改名。",
  titleSaveFailed: "标题未能保存",
  uploadQueuedBehind: "已排队：当前添加完成后开始。",
  ...
  uploadRangeLoading: "读取录音中…",
  uploadRangeStart: "开始",
  uploadRangeEnd: "结束",
  uploadRangeWhole: "导入整段录音",
  uploadRangePart: "导入 {start}–{end}",
  ...
  uploadItemImage: "图片",
  uploadItemMarkdown: "Markdown",
  uploadItemSlides: "幻灯片",
  uploadItemSheets: "电子表格",
  uploadItemPdf: "PDF",
  uploadPageFailed: "{title} —— {reason}",
  ...
  graphPickHint: "正在为缝合选取文档：点击节点选取或取消。选好后在缝合框中按完成。",
  ...
  acceptLink: "接受",
  dismissLink: "忽略",
  linkExpand: "展开此链接：为何建立，以及两端的段落",
  linkCollapse: "收起此链接",
  linkWhy: "为何建立此链接",
  linkNoReason: "手动建立的链接，没有写原因",
  linkOpenEnd: "在阅读器中打开",
