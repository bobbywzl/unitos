...
const en = {
  ...
  questionRequired: "Type a question or attach an image or a file",
  attachmentTooLarge: "File is larger than 20 MB",
  attachmentUnreadable: "Could not read this PDF. The file may be damaged.",
  attachmentNotText: "File is not a text file, a PDF, or an image",
  attachmentEmpty: "File has no text. A scanned PDF has no text layer to read.",
  ...
  outputBudgetSpent: "The output budget ran out before the answer ended. Try again.",
  modelDeclined: "The model declined this request.",
  findFailed: "Find failed. {reason}",
  salienceFailed: "Salience failed. {reason}",
  extractFailed: "Extract failed. {reason}",
  deriveFailed: "Derive failed. {reason}",
  visualizeFailed: "Visualize failed. {reason}",
  visualizeNotRendered: "The picture could not be drawn. {reason}",
  visualizeNeedsUltra: "Visualize is Unitos Ultra.",
  visualizeNeedsKey: "ANTHROPIC_API_KEY is not set. Visualize needs it.",
  continueNeedsUltra: "Continuing a tool's output into a conversation is Unitos Ultra.",
  distillFailed: "Extract failed. {reason}",
  keypointsFailed: "Distill failed. {reason}",
  ...
  distillNoQuotes: "Extract returned no resolvable quotes",
  keypointsNoPoints: "Distill returned no resolvable points",
  ...
  voiceNoteEmpty: "The recording is empty",
  voiceNoteTooLarge: "The recording is too large. Keep a voice note under five minutes.",
  voiceNoteFailed: "Voice note failed. {reason}",
  voiceNoteNoSpeech: "No speech was found in the recording",
  ...
  compareAgree: "Agree",
  compareDisagree: "Disagree",
  compareOnly: "Only in {title}",

  // Documents and ingest
  parsingUnavailable: "Document parsing is unavailable: {message}",
  missingFile: "Missing file",
  notPdf: "File is not a PDF, an image (png, jpg, gif, webp, bmp), or a Markdown file (md, txt)",
  imageUnreadable:
...
const zh: Record<keyof typeof en, string> = {
  ...
  questionRequired: "请输入问题，或附上图片或文件",
  attachmentTooLarge: "文件超过 20 MB",
  attachmentUnreadable: "无法读取此 PDF。文件可能已损坏。",
  attachmentNotText: "文件不是文本文件、PDF 或图片",
  attachmentEmpty: "文件没有文本。扫描版 PDF 没有可读的文本层。",
  ...
  outputBudgetSpent: "输出预算在回答结束前用完。请重试。",
  modelDeclined: "模型拒绝了此请求。",
  findFailed: "查找失败。{reason}",
  salienceFailed: "要点识别失败。{reason}",
  extractFailed: "提取失败。{reason}",
  deriveFailed: "生成失败。{reason}",
  visualizeFailed: "可视化失败。{reason}",
  visualizeNotRendered: "无法绘制这幅图。{reason}",
  visualizeNeedsUltra: "可视化是 Unitos Ultra 功能。",
  visualizeNeedsKey: "未设置 ANTHROPIC_API_KEY。可视化需要它。",
  continueNeedsUltra: "将工具输出继续为对话是 Unitos Ultra 功能。",
  distillFailed: "提取失败。{reason}",
  keypointsFailed: "提炼失败。{reason}",
  formalizeFailed: "整理失败。{reason}",
  salienceNoSpans: "要点识别未返回可定位的片段",
  extractNoSpans: "提取未返回可定位的片段",
  distillNoQuotes: "提取未返回可定位的引文",
  keypointsNoPoints: "提炼未返回可定位的要点",
  ...
  voiceNoteEmpty: "录音为空",
  voiceNoteTooLarge: "录音过大。语音笔记请控制在五分钟以内。",
  voiceNoteFailed: "语音笔记失败。{reason}",
  voiceNoteNoSpeech: "录音中没有语音",
  compareNeedsText: "两篇文档都需要有文本才能对比",
  ...
  compareAgree: "一致",
  compareDisagree: "分歧",
  compareOnly: "仅见于 {title}",

  parsingUnavailable: "文档解析不可用：{message}",
  missingFile: "缺少文件",
  notPdf: "文件不是 PDF、图片（png、jpg、gif、webp、bmp）或 Markdown 文件（md、txt）",
