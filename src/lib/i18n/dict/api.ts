...
const en = {
  ...
  analyzeFailed: "Analyze failed. {reason}",
  // Note text of ANALYZE and COMPARE (SPEC.md §4)
  analysisTitleFigure: "Figure analysis",
  analysisTitleTable: "Table analysis",
  analysisData: "Data",
  analysisReadings: "Readings",
  analysisEstimateNote: "≈ marks a value estimated off the visual, not printed on it.",
  analysisTakeaway: "Takeaway",
  analysisCautions: "Cautions",
...
const zh: Record<keyof typeof en, string> = {
  ...
  analyzeFailed: "分析失败。{reason}",
  analysisTitleFigure: "插图分析",
  analysisTitleTable: "表格分析",
  analysisData: "数据",
  analysisReadings: "读数",
  analysisEstimateNote: "≈ 表示从图上估读的数值，不是图上印出的数值。",
  analysisTakeaway: "结论",
  analysisCautions: "注意",
