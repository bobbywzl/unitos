...
const en = {
  ...
  svcKimi: "Kimi K3: Extract, the parse passes, calls that carry an image, and every GLM call without the gateway",
...
const zh: Record<keyof typeof en, string> = {
  ...
  svcKimi: "Kimi K3：提取、解析步骤、带图片的调用，以及没有网关时的所有 GLM 调用",
