...
const en = {
  ...
  svcKimi: "Kimi K3: Extract, calls that carry an image, and every GLM call without the gateway",
  svcClaude: "Claude Opus 5.5: the parse passes, Import PDF's judgment and conversion, Visualize, SVG charts. Claude Sonnet 5: the voice command",
  ...
  // The model per function (lib/feature-models.ts)
  featureModels: "Model per function",
  featureModelsDesc:
    "The model each function calls. A pick is checked with one probe call before it is saved; a pick that does not answer leaves the function where it was. The default is the constant in the code.",
  featureDefault: "default",
  featureOther: "Other…",
  featureOtherPh: "model id",
  featureSave: "Save",
  ...
  featExtract: "Match-it",
  featDistill: "Extract",
  featSummarize: "Summary",
  featCompare: "Compare two documents",
  featAnalyze: "Analyze a figure or table",
  featVisualize: "Visualize",
  featVoice: "Voice command",
  featSuggest: "The assistant's suggestions",
  featFind: "Find in a video",
  featAsk: "Ask about a time range",
  featFormalize: "Formalize a transcript",
  featAssistant: "Assistant",
  featAct: "Circle & ask",
  featWeb: "Assistant with Web on (a GLM or Kimi model)",
  featVision: "Calls that carry an image",
  featSvgChart: "SVG charts",
  featStitch: "Stitch: the answer pass",
  featStitchSelect: "Stitch: the route and select passes",
  featMerge: "Merge with AI",
  featGist: "Gist",
  featLog: "Conversation log",
  featGlossary: "Glossary",
  featContents: "Contents",
  featCollapse: "Collapse",
  featSkeleton: "Skeleton",
  featConnect: "Recommended links",
  featParse: "Parse passes: URL core, structure, layout",
  featClassify: "Import PDF: judgment",
  featConvert: "Import PDF: conversion",
  envHint:
...
const zh: Record<keyof typeof en, string> = {
  ...
  svcClaude: "Claude Opus 5.5：解析步骤、导入 PDF 的判断与转换、可视化、SVG 图表。Claude Sonnet 5：语音指令",
  ...
  featureModels: "各功能的模型",
  featureModelsDesc:
    "各功能调用的模型。选择会先经一次探测调用再保存；探测无应答则功能保持原模型。默认值是代码中的常量。",
  featureDefault: "默认",
  featureOther: "其他…",
  featureOtherPh: "模型 id",
  featureSave: "保存",
  featureSaving: "检查中…",
  featureSaved: "已保存",
  ...
  featAssistant: "助手",
  featAct: "圈选并提问",
  featWeb: "开启网页的助手（GLM 或 Kimi 模型）",
  featVision: "带图片的调用",
  featSvgChart: "SVG 图表",
  featStitch: "缝合：回答步骤",
  featStitchSelect: "缝合：路由与选择步骤",
  featMerge: "用 AI 合并",
  featGist: "要旨",
  featLog: "对话记录",
  featGlossary: "术语表",
  ...
  featSkeleton: "骨架",
  featConnect: "推荐链接",
  featParse: "解析步骤：URL 核心、结构、版式",
  featClassify: "导入 PDF：判断",
  featConvert: "导入 PDF：转换",
