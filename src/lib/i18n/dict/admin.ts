...
const en = {
  ...
  // Clicks page. A surface is where a control lives; a control is one button
  // or link. Control ids are code and render as-is.
  clicks: "Clicks",
  clicksDesc:
    "How often readers click each control, by surface (where it lives) and control (which function). One row per click, batched from the reader.",
  clicksEmpty: "No clicks recorded yet. Recording starts with the next click in a project.",
  clicks90: "Clicks (90d)",
  clicks30: "Clicks (30d)",
  clicks7: "Clicks (7d)",
  clicksAccounts: "Accounts (90d)",
  clicksControls: "Controls used (90d)",
  clicksDaily: "Daily clicks by surface — last 30 days",
  clicksBySurface: "Clicks by surface (90d)",
  clicksTopControls: "Top controls (90d)",
  clicksBySurfaceControls: "{surface}: top controls (90d)",
  clicksTable: "Every control (90d)",
  clicksByAccount: "Clicks by account (90d)",
  clicksColSurface: "Surface",
  clicksColControl: "Control",
  clicksCol90: "90d",
  clicksCol30: "30d",
  clicksCol7: "7d",
  clicksColAccounts: "Accounts",
  clicksColLast: "Last click",
  clicksColAccount: "Account",
  clicksColClicks: "Clicks",
  clicksSegment: "{day} · {surface} · {n} of {total} clicks",
  clicksShare: "{pct}% of clicks",
  clicksNone: "No clicks.",
  clicksNoAccount: "No account",
  agoNow: "just now",
  agoMinutes: "{n} min ago",
  agoHours: "{n} h ago",
  agoDays: "{n} d ago",
  surfaceTopbar: "Top bar",
  surfaceSidebar: "Sidebar",
  surfaceAiToolbar: "AI toolbar",
  surfaceArticleMenu: "Article menu",
  surfaceReader: "Reader",
  surfaceTray: "Notes tray",
...
const zh: Record<keyof typeof en, string> = {
  ...
  clicks: "点击",
  clicksDesc: "读者点击每个控件的频率，按区域（控件所在位置）和控件（对应功能）统计。每次点击一行，由阅读器分批上传。",
  clicksEmpty: "尚无点击记录。记录从项目内的下一次点击开始。",
  clicks90: "点击（90 天）",
  clicks30: "点击（30 天）",
  clicks7: "点击（7 天）",
  clicksAccounts: "账户（90 天）",
  clicksControls: "使用过的控件（90 天）",
  clicksDaily: "每日点击，按区域——最近 30 天",
  clicksBySurface: "按区域的点击（90 天）",
  clicksTopControls: "点击最多的控件（90 天）",
  clicksBySurfaceControls: "{surface}：点击最多的控件（90 天）",
  clicksTable: "全部控件（90 天）",
  clicksByAccount: "按账户的点击（90 天）",
  clicksColSurface: "区域",
  clicksColControl: "控件",
  clicksCol90: "90 天",
  clicksCol30: "30 天",
  ...
  clicksColAccount: "账户",
  clicksColClicks: "点击",
  clicksSegment: "{day} · {surface} · {n} / {total} 次点击",
  clicksShare: "占点击的 {pct}%",
  clicksNone: "没有点击。",
  clicksNoAccount: "无账户",
  agoNow: "刚刚",
  agoMinutes: "{n} 分钟前",
  ...
  surfaceTopbar: "顶栏",
  surfaceSidebar: "侧栏",
  surfaceAiToolbar: "AI 工具栏",
  surfaceArticleMenu: "文章菜单",
  surfaceReader: "阅读器",
  surfaceTray: "笔记栏",
  services: "服务",
