...
const en = {
  ...
  circleCommentTitle:
    "Pause and circle a spot on the frame — or take the whole frame — then comment",
  audioCommentTitle: "Pause on this moment, then comment",
  linesCount: "{n} lines",
...
const zh: Record<keyof typeof en, string> = {
  ...
  audioCommentTitle: "暂停在这个时刻，然后评论",
  linesCount: "{n} 行",
