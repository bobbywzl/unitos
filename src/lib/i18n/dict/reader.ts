...
const en = {
  ...
  contents: "Contents",
  contentsTitle: "The article's contents: its parts, each a jump to where it starts.",
  ...
  // Collapse (SPEC.md §28): every block shown as its core — what it really
  // says, in plain words — with a click to read the block whole.
  collapse: "Collapse",
  collapsed: "Collapsed",
  ...
  coreFoldTitle: "Collapse this block to its core again",
  coreAnnotatedTitle: "This block has annotations. Read it whole to see them.",
  coreFigure: "Figure",
  coreTable: "Table",
  coreEquation: "Equation",
  coreCode: "Code",
  coreSlide: "Slide",
  coreSheet: "Sheet",
  ...
  visualizeDeclined: "Not enough certainty for a picture that carries the core idea of this passage. Visualization declined.",
  visualizeDeclinedHint: "Use the assistant, Explain, or Simplify for this passage instead.",
  deleteVisualizeTitle: "Delete this visualization and its mark",
  openVisualization: "Open",
  openVisualizationTitle: "Open the picture large, with its caption",
  visualizationRemoved: "Visualization removed",
  ...
  extractionRemoved: "Match removed",
...
const zh: Record<keyof typeof en, string> = {
  ...
  coreFoldTitle: "把这个块重新折叠为核心",
  coreAnnotatedTitle: "这个块有批注。阅读全文可看到它们。",
  coreFigure: "插图",
  coreTable: "表格",
  coreEquation: "公式",
  coreCode: "代码",
  ...
  visualizing: "可视化中…",
  visualization: "可视化图",
  visualizeDeclined: "没有足够把握画出能传达这段文字核心思想的图。可视化已拒绝。",
  visualizeDeclinedHint: "请改用助手、解释或简化来理解这段文字。",
  deleteVisualizeTitle: "删除此可视化图及其标记",
  openVisualization: "打开",
  openVisualizationTitle: "放大打开这幅图，并显示说明",
  visualizationRemoved: "可视化图已删除",
  simplified: "简化",
  dragToMove: "拖动以移动",
