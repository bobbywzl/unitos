...
const en = {
  ...
  ask: "Ask",
  auto: "Auto",
  askAutoTitle: "Ask first shows every plan for approval. Auto applies it immediately.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  anchorsFirstParagraph: "锚定到所选内容的第一段",
  run: "运行",
  ask: "询问",
  auto: "自动",
  askAutoTitle: "“询问”先展示每个计划等你批准。“自动”立即应用。",
  assistantPlaceholder: "告诉助手要对所选内容做什么…",
  stopListening: "停止聆听",
  speakCommand: "说出命令",
  ...
  addPendingNote: "作为待定笔记加入{section}",
  extracting: "提取中…",
