...
const en = {
  ...
  ask: "Ask",
  askTitle: "Send the question (Enter)",
  ...
  taskGapsTitle: "Find what the notes leave out",
  taskUnsourcedTitle: "Find notes with no source in the documents",
...
const zh: Record<keyof typeof en, string> = {
  ...
  taskGapsTitle: "找出笔记的疏漏",
  taskUnsourcedTitle: "找出在文档中没有出处的笔记",
