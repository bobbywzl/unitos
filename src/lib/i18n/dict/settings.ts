...
const en = {
  ...
  drive: "Google Drive",
  driveDesc: "Link Google Drive to pick files without a sign-in popup and to add Drive links directly.",
  driveLinkedDesc: "Google Drive is linked. Picks and pasted Drive links use this grant.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  drive: "Google Drive",
  driveDesc: "关联 Google Drive：选取文件无需再次授权，也可直接粘贴 Drive 链接添加。",
  driveLinkedDesc: "Google Drive 已关联。选取文件与粘贴的 Drive 链接都使用此授权。",
