...
const en = {
  ...
  billing: "Billing",
  billingDone: "Your subscription is active.",
  billingMonthly: "Monthly",
  billingYearly: "Yearly",
  billingSaveBadge: "Save {n}%",
  billingPerMonth: "/month",
  billingPerYear: "/year",
  billingBilledYearly: "Billed {amount} a year",
  billingUpgrade: "Upgrade to {tier}",
  billingManage: "Manage billing",
  billingEnds: "Ends {date}",
  billingRenews: "Renews {date}",
  drive: "Google Drive",
...
const zh: Record<keyof typeof en, string> = {
  ...
  billingMonthly: "按月",
  billingYearly: "按年",
  billingSaveBadge: "省 {n}%",
  billingPerMonth: "/月",
  billingPerYear: "/年",
  billingBilledYearly: "按年收费 {amount}",
  billingUpgrade: "升级到 {tier}",
  billingManage: "管理账单",
  billingEnds: "{date} 到期",
  billingRenews: "{date} 续费",
  drive: "Google Drive",
