...
export function formalizePrompt(ctx: PromptCtx): string {
  ...
  return [
    ...
    "2. heading: the topic in a few words. bullets: the points that matter — claims, numbers, examples, decisions — one point per bullet, one line each, short and concrete. State the point itself with its number, never that a point was made.",
