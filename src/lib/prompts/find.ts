...
export function findPrompt(ctx: PromptCtx): string {
  return [
    ...
    "2. For each match, list the exact block ids it spans, in order, and explain in 1–3 sentences what that part says and why it answers the search. Quote key phrases from the transcript.",
