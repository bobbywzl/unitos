...
const cursorPath =
  "M5.5 3.2v16.2l4.1-3.9 2.5 5.6 2.7-1.2-2.5-5.5 5.6-.6L5.5 3.2Z";
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              className="si-p-join"
              style={badge(20, 8.5, "#7a8a5e", { marginLeft: -6, ...ringed })}
            >
              J
            </span>
            <span
              style={badge(20, 8.5, "#645c50", { marginLeft: -6, ...ringed })}
            >
              R
            </span>
          </span>
        ...
        >
          ...
          >
            ...
            <span className="si-p-editmark" style={{ borderRadius: 2 }}>
              At each step the model is auto-regressive, consuming the
          ...
          <p style={{ margin: "4px 0 0", color: "#474238" }}>
            ...
            layer has two sub-layers: a multi-head self-attention mechanism and
        ...
        <div
          style={{
            ...
            fontSize: 10,
            boxShadow:
              "0 6px 18px rgba(46,43,37,0.12), inset 0 0 0 1px #e8dfd0",
          }}
        >
          <span style={{ display: "inline-flex" }}>
            <span style={badge(16, 7, "#c67139", ringed)}>M</span>
            <span
              style={badge(16, 7, "#7a8a5e", { marginLeft: -5, ...ringed })}
            >
              J
            </span>
            <span
              style={badge(16, 7, "#645c50", { marginLeft: -5, ...ringed })}
            >
              R
            </span>
          </span>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={badge(14, 7, "#7a8a5e", { marginLeft: "auto" })}>
              J
            </span>
          ...
          <p style={{ margin: "5px 0 0", color: "#474238" }}>
            <span style={{ textDecoration: "line-through", color: "#b5a892" }}>
              consuming the previously generated symbols
            </span>{" "}
            <span style={{ background: "#e3e8d6", borderRadius: 2 }}>
              conditioning on every symbol generated so far
            </span>
          </p>
          <div style={{ display: "flex", gap: 4, marginTop: 6 }}>
            <span
              className="si-p-editaccept"
              style={{
                borderRadius: 9999,
                padding: "2px 9px",
                fontWeight: 700,
            ...
            <span
              style={{ marginLeft: "auto", fontWeight: 700, color: "#645c50" }}
            >
              Reply
            </span>
          </div>
        ...
        >
          ...
          <p style={{ margin: "5px 0 0", fontWeight: 700, color: "#2e2b25" }}>
            Encoder = continuous representations
          </p>
          <p style={{ margin: "2px 0 0", color: "#474238" }}>
            The encoder&apos;s job is only the mapping to z; generation is the
            decoder&apos;s. Worth a diagram for the group.
          </p>
          <p
            style={{
              margin: "5px 0 0",
          ...
          >
            ...
            >
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                ...
                >
                  ...
                  <span style={{ fontSize: 8.5, color: "#b5a892" }}>
                    Sep 20, 13:04
                  </span>
                  <span
                    className="si-p-resolvebtn"
                    style={{
                      marginLeft: "auto",
                      fontSize: 8.5,
                      fontWeight: 700,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <span
                className="si-p-count"
                style={{ fontSize: 9, fontWeight: 700, color: "#82796a" }}
              >
                1 resolved
              </span>
              <span
                className="si-p-compose"
                style={{
                  display: "flex",
                  flex: 1,
                  gap: 4,
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ marginLeft: "auto", fontSize: 9, color: "#b5a892" }}>
              ···
            </span>
          </div>
          <p
          ...
          >
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              ...
              <p style={{ margin: "1px 0 0", color: "#474238" }}>
        ...
        >
          ...
          >
            <b>History</b> · Jon edited ¶ 2 · Mira added #e91b · Rui highlighted
            ¶ 1
          </span>
