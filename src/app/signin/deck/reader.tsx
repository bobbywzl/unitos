...
const dots = (name: string) => (
  <div
    className="si-r-think"
    style={{ animation: `${name} 18s linear infinite` }}
  >
...
const gem = (size: number) => (
  <svg width={size} height={size} viewBox="0 0 24 24">
    <path
      d="M7 4h10l4.5 5.5L12 21 2.5 9.5Z"
      fill="#1a1713"
      stroke="#d6b26a"
      strokeWidth="2"
    />
      ...
      >
          ...
          >
            ...
            <span
              style={{
                borderRadius: 2,
                backgroundImage:
                  "linear-gradient(#f6e3a8, #f6e3a8), linear-gradient(#dcd0ff, #dcd0ff)",
            ...
            <span
              style={{
                ...
                background: "#ffffff",
                padding: "5px 8px",
                boxShadow: "0 8px 24px rgba(46,43,37,0.18)",
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span
                  style={{
                    ...
                    overflow: "hidden",
                    whiteSpace: "nowrap",
                    animation: "si-r-box 18s linear infinite",
                  }}
                >
                  <span
                    style={{
                  ...
                  <span
                    style={{
                      ...
                      width: 0,
                      animation: "si-r-type 18s linear infinite",
                    }}
                  >
                    What does dropping recurrence and convolutions actually
                    change?
                  </span>
                </span>
                <span
                  style={{
                    ...
                    padding: "4px 10px",
                    fontWeight: 700,
                    animation: "si-r-run 18s linear infinite",
                  }}
                >
                  Run
                </span>
              ...
              <span style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
                <span
                  style={{
                    ...
                    color: "#8c491a",
                    background: "#fbe3d3",
                    animation: "si-r-press 18s linear infinite",
                  }}
                >
                  Simplify
                </span>
                <span
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    gap: 4,
                    animation: "si-r-press2 18s linear infinite",
                  }}
                >
                  {gem(9)}
                  Visualize{" "}
                  <span style={{ fontSize: 8.5, color: "#82796a" }}>Ultra</span>
                </span>
        ...
        >
          ...
          <div
            style={{
              ...
              animation: "si-r-card 18s linear infinite",
            }}
          >
            <div
              style={{
            ...
            >
              <span
                style={{
                  fontWeight: 700,
                  color: "#2e2b25",
                  animation: "si-r-title-a 18s linear infinite",
                }}
              >
                Simplifying…
              </span>
              <span
                style={{
                  ...
                  fontWeight: 700,
                  color: "#2e2b25",
                  animation: "si-r-title-b 18s linear infinite",
                }}
              >
                Simplified
              </span>
            ...
            <div style={{ padding: "5px 11px 9px", color: "#474238" }}>
              ...
              <p
                style={{
                  ...
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-s1 18s linear infinite",
                }}
              >
                <span
                  style={{
              ...
              <p
                style={{
                  ...
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-s2 18s linear infinite",
                }}
              >
                It relates the words of a sentence using attention only — each
                word looks at all the others. The two older building blocks,
                recurrence (reading word after word) and convolutions (sliding
                windows), are dropped completely.
              </p>
              <div
                style={{
                  display: "flex",
                  ...
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-s3 18s linear infinite",
                }}
              >
                <span
                  style={{
                ...
                <span style={{ color: "#b5a892" }}>
                  Press a sentence for its original
                </span>
              </div>
            </div>
          </div>
          ...
          <div
            style={{
              ...
              background: "#ffffff",
              boxShadow: cardShadow,
              animation: "si-r-vcard 18s linear infinite",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              <span
                style={{
                  fontWeight: 700,
                  color: "#2e2b25",
                  animation: "si-r-vtitle-a 18s linear infinite",
                }}
              >
                Visualizing…
              </span>
              <span
                style={{
                  ...
                  fontWeight: 700,
                  color: "#2e2b25",
                  animation: "si-r-vtitle-b 18s linear infinite",
                }}
              >
                Visualization
              </span>
              ...
              >
                <span
                  style={{
                    ...
                    color: "#474238",
                    boxShadow: "inset 0 0 0 1px #e8dfd0",
                    animation: "si-r-vbody 18s linear infinite",
                  }}
                >
                  Open
                </span>
            ...
            <div style={{ padding: "5px 11px 9px" }}>
              ...
              <div
                style={{
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-vbodyh 18s linear infinite",
                }}
              >
                <svg
                  viewBox="0 0 240 84"
                ...
                >
                  ...
                  >
                    ...
                    <g
                      ...
                      strokeLinecap="round"
                      fill="none"
                      style={{ animation: "si-r-vdraw 18s linear infinite" }}
                    >
                      <path
                        d="M175 50 Q187 32 199 50M175 50 Q199 26 223 50M175 50 Q193 38 211 50M187 50 Q199 38 211 50M187 50 Q205 32 223 50M199 50 Q211 38 223 50"
                        strokeOpacity="0.75"
                      />
                    </g>
                    ...
                    <text
                      ...
                      fill="#8c491a"
                    >
                      every word, every other, at once
                    </text>
                  </g>
                </svg>
                <p
                  style={{ margin: "6px 0 0", fontSize: 9.5, color: "#645c50" }}
                >
                  “Dispensing with recurrence and convolutions entirely”: the
                  two mechanisms crossed out, the one the Transformer keeps.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            style={{
              ...
              background: "#ffffff",
              boxShadow: cardShadow,
              animation: "si-r-acard 18s linear infinite",
            }}
          >
            <div
              style={{
            ...
            >
              {spark(10)}
              <span style={{ fontWeight: 700, color: "#2e2b25" }}>
                Assistant
              </span>
              <span style={{ fontSize: 9, color: "#b5a892" }}>
                on the selection · ¶ 1
              </span>
            ...
            >
              ...
              <p
                style={{
                  ...
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-a1 18s linear infinite",
                }}
              >
                No recurrence: positions are computed in parallel, so a training
                step no longer waits on the previous word.{" "}
                <span style={{ color: "#c67139" }}>§3.2, Table 1</span>
              </p>
              <p
                style={{
                  margin: 0,
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-a2 18s linear infinite",
                }}
              >
                No convolutions: two distant words meet in one attention step,
                not through a stack of layers.{" "}
                <span style={{ color: "#c67139" }}>§4</span>
              </p>
              <p
                style={{
                  margin: 0,
                  overflow: "hidden",
                  maxHeight: 0,
                  animation: "si-r-a3 18s linear infinite",
                }}
              >
                What replaces them: multi-head self-attention, feed-forward
                layers, and positional encodings to carry word order.{" "}
                <span style={{ color: "#c67139" }}>§3.1, §3.5</span>
              </p>
              <div
                style={{
                  display: "flex",
        ...
        >
          ...
          <span
            style={{
              ...
              padding: "2px 8px",
              fontWeight: 700,
              animation: "si-r-count 18s linear infinite",
            }}
          >
            Annotations · 3
          </span>
        ...
        <span
          style={{
            ...
            background: "#f1ebe0",
            color: "#82796a",
            boxShadow: "0 1px 3px rgba(46,43,37,0.12)",
          }}
        >
          <svg
            width="13"
        ...
        <div
          ...
          style={{
            ...
            inset: 0,
            pointerEvents: "none",
            animation: "si-r-cur 18s cubic-bezier(.5,.1,.3,1) infinite",
          }}
        >
          <svg
            width="18"
