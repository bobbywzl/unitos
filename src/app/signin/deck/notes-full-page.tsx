...
const paneQuote: CSSProperties = {
  margin: "8px 0 0",
  paddingLeft: "7px",
  borderLeft: "2px solid #c67139",
  color: "#645c50",
};
const paneMeta: CSSProperties = {
  margin: "8px 0 0",
  fontSize: "9px",
  color: "#b5a892",
};
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontFamily: caprasimo, fontSize: "13px" }}>
            Comparing 3 notes
          </span>
          <span
            style={{
        ...
        >
          <div style={pane}>
            ...
            <div style={{ padding: "10px" }}>
              ...
              <p style={paneBody}>
                Every position attends to every other in one step — no
                sequential chain, so training parallelizes across the sentence.
              </p>
              <p style={paneQuote}>
                “dispensing with recurrence and convolutions entirely”{" "}
                <span style={ref}>¶ 1</span>
              </p>
          ...
          <div style={pane}>
            ...
            <div style={{ padding: "10px" }}>
              ...
              <p style={paneBody}>
                Parallel attention means the whole batch runs at once: 12 hours
                on eight P100s to a new BLEU record.
              </p>
              <p style={paneQuote}>
                “trained for 12 hours on eight P100 GPUs”{" "}
                <span style={ref}>¶ 4</span>
              </p>
          ...
          <div style={pane}>
            ...
            <div style={{ padding: "10px" }}>
              ...
              <p style={paneBody}>
                Two records with one architecture. The En–Fr number came from
                3.5 days of training.
              </p>
              <p style={paneQuote}>
                “a new single-model state-of-the-art BLEU score of 41.8”{" "}
                <span style={ref}>¶ 3</span>
              </p>
        ...
        >
          ...
          <div
            className="si-c-held"
            style={{ ...row, position: "relative", zIndex: 2 }}
          >
            <div style={rowHead}>
            ...
            <p style={rowBody}>
              Parallel attention means the whole batch runs at once: 12 hours on
              eight P100s to a new BLEU record.
            </p>
            <p style={rowQuote}>
              “trained for 12 hours on eight P100 GPUs”{" "}
              <span style={ref}>¶ 4</span>
          ...
          <div className="si-c-up" style={row}>
            ...
            <p style={rowBody}>
              Two records with one architecture. The En–Fr number came from 3.5
              days of training.
            </p>
            <p style={rowQuote}>
              “a new single-model state-of-the-art BLEU score of 41.8”{" "}
          ...
          <div className="si-c-up" style={row}>
            ...
            <p style={rowBody}>
              Self-attention was already in reading comprehension and entailment
              models; the Transformer is the first to rely on it alone.
            </p>
            <p style={rowQuote}>
              “the first transduction model relying entirely on self-attention”{" "}
              <span style={ref}>¶ 9</span>
            </p>
          </div>
          <div className="si-c-up" style={row}>
            <div style={rowHead}>
            ...
            <p style={rowBody}>
              Attention is O(n²) in sequence length — fine at 512 tokens, ask
              Stitch what Scaling Laws says past that.
            </p>
          </div>
        </div>
        ...
        <div
          ...
          style={{
            ...
            fontSize: "10.5px",
            boxShadow:
              "0 10px 24px rgba(46,43,37,0.2), inset 0 0 0 1px #e8dfd0",
            whiteSpace: "nowrap",
          }}
        >
