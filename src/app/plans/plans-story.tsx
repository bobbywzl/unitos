...
// The plans story (SPEC.md §24): the acts from the cream hero to the night
// sky, then the choice — the account line and the plan cards on the night
// ground. The plans page (/plans) wraps it in its nav; the sign-in page
// embeds it under the front door. One component, so the two cannot differ.
// The caller gates on the billing switch and wraps it in .plans-root.
export async function PlansStory({ preview }: { preview: boolean }) {
