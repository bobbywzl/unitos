...
export function VideoPane({
  ...
  // capture for the assistant. Everything else is the same surface (SPEC.md §11).
  ...
  const transcriptView: TranscriptVariant = {
    ...
    // widens it — capped so the frame stays fully on screen. It centers like
    // the article column (globals.css .reader-column), so Top and Bottom with
    // the tray in view keeps it clear of the strip's edge.
    columnStyle: {
