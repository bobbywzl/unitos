...
2. **One term per concept, everywhere.** The vocabulary is fixed: notebook, section, note, source, anchor, block, derivation, pending, accepted. Use these exact words in UI, code, prompts, and docs. Never introduce a second name for an existing concept.
