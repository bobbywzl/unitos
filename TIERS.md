...
and on the admin accounts page; in the header it is the tier button while
billing is on (SPEC.md §24): a Unitos Premium account presses it for the
upgrade panel, a Unitos Ultra account for the plans page. The subscription
panel under Subscription in Settings shows the chip with the plan's status,
the card, and the actions on the subscription, and what the tier holds
under them; a hairline band in the material runs along the top of the
...
- **2026-09-18** — Offline copies are Unitos Ultra (SPEC.md §17): Save for
  ...
  Chrome. Offline work itself (the queued writes) stays Premium; AI stays
