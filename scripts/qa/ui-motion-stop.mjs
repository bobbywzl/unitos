...
// ingest reasons. Needs the dev server on :3000 with the mock Anthropic server
// on :3399 (start the dev server with ANTHROPIC_API_KEY=mock
// ANTHROPIC_BASE_URL=http://localhost:3399) and outbound network for the
